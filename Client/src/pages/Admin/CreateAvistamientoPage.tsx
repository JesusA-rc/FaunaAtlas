...
const CreateAvistamientoPage = () => 
{
  ...
  const onSubmit = async (values: AvistamientoFormValues) => 
  {
    ...
    setSuccess(false);
    try {
      await avistamientoService.create(values as any);
      setSuccess(true);
      ...
      if (error.response?.data) {
        ...
        setServerError('Ocurrió un error inesperado al registrar el avistamiento.');
      }
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-10 text-center">
          ...
          <h1 className="text-4xl font-heading font-bold text-white mb-3">
            Registrar <span className="text-mint">Nuevo Avistamiento</span>
          </h1>
          <p className="text-slate max-w-lg">
            Ingresa los detalles del encuentro registrado en campo para mantener actualizada la base de datos.
          </p>
        </div>

        <AvistamientoForm 
          onSubmit={onSubmit} 
          submitLabel="Registrar Avistamiento" 
...
export default CreateAvistamientoPage;
